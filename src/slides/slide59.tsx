...
const snbImages = [
  {
    src: '/assets/SNB/nsb@apple.png',
    alt: 'SNB poster on Apple',
    className: 'md:col-span-7 md:row-span-8',
  },
  {
    src: '/assets/SNB/signs%20presntation.png',
    alt: 'SNB signs presentation',
    className: 'md:col-span-5 md:row-span-4',
  },
  {
    src: '/assets/SNB/sync%20presentation.png',
    alt: 'SNB sync presentation',
    className: 'md:col-span-5 md:row-span-4',
  },
];
